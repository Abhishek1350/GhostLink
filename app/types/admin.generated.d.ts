...
export type UrlRedirectQueryVariables = AdminTypes.Exact<{ [key: string]: never; }>;


export type UrlRedirectQuery = { urlRedirects: { nodes: Array<Pick<AdminTypes.UrlRedirect, 'id' | 'path' | 'target'>>, pageInfo: Pick<AdminTypes.PageInfo, 'hasNextPage' | 'hasPreviousPage'> } };
