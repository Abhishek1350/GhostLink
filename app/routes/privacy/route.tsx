    ...
    <div className={styles.page}>
      <div className={styles.inner}>
        ...
        <p className={styles.intro}>
          GhostLink ("we", "us", or "our") provides a Shopify app that helps
          ...
          protect information when you install and use the GhostLink app on your
          Shopify store.
        </p>

        <p className={styles.intro}>
          By installing and using GhostLink, you agree to the collection and use
        ...
        <article className={styles.content}>
          ...
          <p>
            When you install GhostLink, Shopify provides us with basic
            information about your store, including:
          </p>
          <ul>
            <li>
              Your shop domain (for example, <code>your-store.myshopify.com</code>)
            </li>
          ...
          <ul>
            ...
            <li>Authenticate API requests between GhostLink and Shopify</li>
            <li>Provide support when you contact us</li>
          </ul>

          <h3>1.2 404 / broken link logs</h3>
          <p>
            To provide our core functionality, GhostLink records information
          ...
          <ul>
            ...
            <li>
              A <strong>hit count</strong> (how many times a broken path has been
              visited)
            </li>
          ...
          <ul>
            <li>Display broken links in your GhostLink dashboard</li>
            <li>Help you decide which links to fix</li>
            <li>
              Automatically create redirects when you enable Auto-Pilot
            </li>
          </ul>
          ...
          <p>
            We maintain basic installation and usage analytics to keep GhostLink
            running reliably, such as:
          </p>
          <ul>
            <li>Your shop domain</li>
            <li>When GhostLink was first installed or reinstalled</li>
          ...
          <p>
            ...
            issues, and improve GhostLink over time.
          </p>

          <h3>1.4 End-customer data</h3>
          <p>
            GhostLink is designed to work primarily with{" "}
          ...
          <p>
            ...
            GhostLink interacts with Shopify APIs, we follow Shopify's{" "}
            <a
          ...
          <ul>
            <li>Operate and provide the GhostLink app and its features</li>
            <li>
              Detect and display broken links in your GhostLink dashboard
            </li>
            <li>
              Create Shopify URL redirects when you fix a broken link or
              enable Auto-Pilot
            </li>
            <li>
              Diagnose and fix bugs, monitor uptime, and improve app
              performance
            </li>
            <li>
          ...
          <p>
            GhostLink stores your data in a secure database managed by our
            hosting provider. The specific region may vary depending on our
            infrastructure (for example, within the EU or US). We take
            reasonable technical and organizational measures to protect this data
          ...
          <ul>
            <li>
              ...
              GhostLink installed, and for a reasonable period afterwards to
          ...
          <ul>
            <li>
              <strong>Service providers</strong> who help us operate GhostLink
          ...
          <p>
            As a Shopify app, GhostLink adheres to Shopify's privacy and data
          ...
          <ul>
            <li>
              Access the data we store about your shop in relation to GhostLink
            </li>
            ...
            <li>Uninstall GhostLink at any time from your Shopify admin</li>
          </ul>
          <p>
            To exercise any of these rights, please contact us at the address
            below or via the{" "}
            <Link to="/#contact">Contact section</Link> on our website.
          </p>
          ...
          <p>
            ...
            changes are material, we may also notify you via the GhostLink app
            or by email.
          </p>
          ...
          <h2>9. Contact us</h2>
          <p>
            If you have any questions about this Privacy Policy or how GhostLink
          ...
          <ul className={styles.contactList}>
            ...
            <li>
              ✉️{" "}
              <a href="mailto:support@imabhishek.site">
                support@imabhishek.site
              </a>
            </li>
          </ul>
        </article>
